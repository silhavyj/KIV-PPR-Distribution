...
namespace kiv_ppr
{
    ...
    CChi_Square::TResult CTest_Runner::Run_Normal()
    {
        ...
        return chi_square_normal.Run(CNormal_CDF::DF);
    }

    CChi_Square::TResult CTest_Runner::Run_Uniform()
    {
        ...
        return chi_square_uniform.Run(CUniform_CDF::DF);
    }

    CChi_Square::TResult CTest_Runner::Run_Exponential()
    {
        ...
        return chi_square_exponential.Run(CExponential_CDF::DF);
    }

    CChi_Square::TResult CTest_Runner::Run_Poisson()
    {
        ...
        return chi_square_poisson.Run(CPoisson_CDF::DF);
    }
}