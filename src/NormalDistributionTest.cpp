...
namespace kiv_ppr
{
    ...
    bool CNormal_Distribution_Test::Is_Normal_Distribution(double tolerance) const
    {
    ...
    {
        return static_cast<double>(m_category_68) / static_cast<double>(m_file->Get_Total_Number_Of_Valid_Elements());
    }

    [[nodiscard]] double CNormal_Distribution_Test::Get_Category_95() const noexcept
    {
        return static_cast<double>(m_category_95) / static_cast<double>(m_file->Get_Total_Number_Of_Valid_Elements());
    }

    [[nodiscard]] double CNormal_Distribution_Test::Get_Category_99_7() const noexcept
    {
        return static_cast<double>(m_category_99_7) / static_cast<double>(m_file->Get_Total_Number_Of_Valid_Elements());
    }
